...
public class Test1 {
	...
	public void testExpression() {
		 ...
		 * ≤‚ ‘”√¿˝1  ≤‚ ‘¥˙¬Î
		 */
		String inputString ="(67fan^(1+3)+	(888y+  We are not"+
		 " the same variable+"+"(45x^2+(13lx^7y^12+(67x*x+(888y"+
		"*x+(45zoo^9+(13x^9y^12+		(67x^11+(888y^2+(45x^5+"+
		 "(13x^7y^11+(67x*x*x+   (888y*y*x+(45x^10+"+
		 "(13x^19y^12))))))))))))))))"; 
		
		String resultString = "888*y+112*x^2+888*y^2+888*x*y+"+
		"67*x^3+888*x*y^2+67*fan^4+45*x^5+We*are*not*same*the*"+
