...
public class Test4 {
	...
	public void testExpression(){
		...
		"(13x^19y^12))))))))))))))))";
		String resultString = "888*y+112*x^2+888*y^2+888*x"+
		"*y+67*x^3+888*x*y^2+45*x^5+268*an^4*f+We*are*not*"+
		"same*the*variable+45*zoo^9+45*x^10+67*x^11+13*x^7"+
		"*y^11+13*lx^7*y^12+13*x^9*y^12+13*x^19*y^12";
      try {
